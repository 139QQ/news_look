...
from backend.newslook.core.logger_manager import get_database_logger
import uuid
...
class NewsDatabase:
    ...
    def __init__(self, db_path=None, use_all_dbs=False):
        ...
        # 使用新的配置管理器
        config = get_config()
        settings = get_settings()  # 保持兼容性
        
        # 从新配置管理器获取数据库配置
        db_config = config.database
        self.db_dir = db_config.db_dir
